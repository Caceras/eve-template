...
- `refresh-connection.eval.ts` installs a fixture Linear connection and checks that both the existing authoring session and a fresh session discover and call it.
