...
/** Advertises, in milliseconds, how long the stream route waits without an event before it ends the response. */
export const EVE_STREAM_IDLE_CLOSE_HEADER = "x-eve-stream-idle-close-ms";
