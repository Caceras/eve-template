...
if test -z "${PLAYWRIGHT_CHROMIUM_EXECUTABLE:-}"; then
...
# eve's deterministic mock model lets browser checks run real chat turns without a provider key.
export AEGENTICA_TEST_MODEL=mock
